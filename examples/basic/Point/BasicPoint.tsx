...
import { Chart, Axis, Tooltip, Point, ScaleType } from 'react-native-statistic-charts'
    ...
    return (
      <View style={{ paddingTop: 100, height: Dimensions.get('window').height, backgroundColor: 'white' }}>
        <Chart
          ...
          scale={{ 月份: { type: ScaleType.Category, range: [0.1, 0.9] } }}
        >
          <Axis
            field="月份"
          ...
          <Point position="月份*月均降雨量" size={2} color={['orange']} />
          <Tooltip
            crosshair
            crosshairsType="x"
