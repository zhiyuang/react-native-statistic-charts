...
import { Chart, Axis, Tooltip, Line, Area } from 'react-native-statistic-charts'
    ...
    return (
      <View style={{ marginTop: 100, marginLeft: 10 }}>
        <Chart
          ...
          animation={{ update: { type: 'gradual', duration: 400 }, enter: { duration: 500 } }}
        >
          ...
          <Area position="date*value" style={{ fill: 'linear-gradient(90deg, #FFB802 0%, #FFFDF8 100%)' }} />
          <Tooltip
            crosshair
            crosshairsType="x"
        ...
        <View>
          <TouchableWithoutFeedback
            onPress={() => {
              if (this.state.data.length > this.data.length) {
                this.setState({ data: this.data })
              } else {
                this.setState({ data: [...this.data, ...this.data2] })
              }
            }}
          >
            <Text>UPDATE</Text>
